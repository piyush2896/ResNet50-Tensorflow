...
def make_batches_and_save(path, output_path=None, batch_type='train',
    ...
    if dev_set_out != None:
        ...
        make_batches_and_save_helper(val_list, path, dev_set_out, 'dev', img_shape, batch_size)


if __name__ == '__main__':
    make_batches_and_save('../Dog-vs-Cat-Tensorflow/datasets/train',
                          './datasets/train_set', batch_size=64, n_dev_set=2000,
                          dev_set_out='./datasets/dev_set')
